      ...
      <div className="max-w-4xl mx-auto">
        <div className="flex items-center justify-between mb-2">
          <div>
            ...
            <div className="text-xs text-[#A01550] font-medium truncate max-w-[200px] sm:max-w-none">{label}</div>
          </div>
          <span className="text-xs font-semibold text-gray-400 flex-shrink-0 ml-2">{pct}%</span>
        </div>
