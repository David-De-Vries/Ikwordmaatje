    ...
    <div className="min-h-screen flex items-center justify-center px-4" style={{ backgroundColor: "#8CBFBB" }}>
      <div className="bg-white rounded-2xl shadow-xl w-full p-8" style={{ maxWidth: 480 }}>
        ...
        <button
          ...
          className="mt-4 w-full py-3 rounded-lg bg-[#A01550] text-white text-sm font-semibold hover:bg-[#87113f] transition"
        >
          Account aanmaken
        </button>
        ...
        <div className="flex items-center gap-3 my-5">
          ...
          <span className="text-xs text-gray-400">of ga verder met</span>
          <div className="flex-1 h-px bg-gray-200" />
        </div>
