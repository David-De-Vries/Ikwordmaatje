...
export default function DashboardPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col" style={{ backgroundColor: "#F2F3F5" }}>
      {/* Top bar — full width, teal */}
      <header className="sticky top-0 z-20" style={{ backgroundColor: "#8CBFBB" }}>
        <div className="mx-auto px-4 py-3 flex items-center justify-between" style={{ maxWidth: 480 }}>
      ...
      {/* Main content — centered, phone-width */}
      <main className="flex-1 mx-auto w-full px-4 py-4 pb-20" style={{ maxWidth: 480 }}>
        {activeTab === "dashboard" && (
          <div className="space-y-4">
            ...
            <div className="bg-white rounded-2xl p-4 border border-gray-200">
              ...
              <div className="grid grid-cols-3 gap-2 mt-4">
                {[
                  ...
                  <div key={stat.label} className="rounded-xl p-2 flex items-center gap-2" style={{ backgroundColor: stat.bg }}>
            ...
            <div className="bg-white rounded-2xl p-4 border border-gray-200">
              ...
              <div className="flex gap-3 p-3 rounded-xl border border-gray-100" style={{ backgroundColor: "#FAFAFA" }}>
        ...
        {activeTab === "instellingen" && (
          <div className="space-y-4">
            ...
            <div className="bg-white rounded-2xl p-4 border border-gray-200">
              ...
              <div className="flex items-center gap-3 mb-4 p-3 rounded-xl" style={{ backgroundColor: "#F7F8FA" }}>
            ...
            {/* Uitloggen */}
            <div className="bg-white rounded-2xl p-4 border border-gray-200">
              <button className="flex items-center gap-3 text-sm font-medium text-gray-500 hover:text-gray-700 transition">
                <LogOut size={17} />
                Uitloggen
              </button>
            </div>
      ...
      <nav className="fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200 z-20">
        <div className="mx-auto flex justify-around px-1 py-2" style={{ maxWidth: 480 }}>
          {NAV.map(({ id, icon: Icon, label }) => (
            <button
              key={id}
              onClick={() => setActiveTab(id)}
              className="flex flex-col items-center py-1 px-2 rounded-lg transition min-w-0"
